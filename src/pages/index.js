    ...
    <>
      ...
      <header>
        <nav class="Navbar">
          <div class="wrapper">
            <ul class="menu">
              {/* <li class="logo"><img src="logo.png" alt="Назва логотипу"></li> */}
              <li><a href="#">Home</a></li>
      ...
      <section class="heading wrapper">
        <div class="text1">
          <span class="subtext">sub-headline</span>
      ...
      <section class="heading1 wrapper">
        <div class="text2">
          <span class="subtext1">sub-headline</span>
          <h2>a church that's relevant</h2>
        </div>
        ...
        <div class="text2">
          <span class="subtext2">our mission & vision</span>
      ...
      <section>
        <div class="my-block">
          ...
          <div class="image-wrapper">
            ...
            <h5 class="image-title">WATCH AND LISTEN TO OUR SERMONS</h5>
      ...
      <section class="block-info wrapper">
        <span class="block-info1">Watch and listen</span>
        <h2 class="block-info2">join us and become part of something great</h2>
      ...
      <section class="container">
        <img src="Image/image-church.png" alt="background" class="bg-img" />
        <div class="content">
          <h2>We want to serve the world around us</h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do.</p>
          <button>Visit</button><hr class="line" />

          <img src="Image/Quote icon.png" alt="icon" class="icon" />
        </div>
      </section>

      <section class="blocks-blog wrapper">
        <span class="blog">Read our Blog</span>
        <h2 class="blog1">SHARE, INSPIRE, INNOVATE</h2>
        <div class="blocks">
          <div class="block">
        ...
        <div class="footer-block">
          ...
          <div class="content-left">
            ...
            <br/>
              ...
              <br/>
                <span class="content-address">4517 Washington Ave. </span>
                <br/>
